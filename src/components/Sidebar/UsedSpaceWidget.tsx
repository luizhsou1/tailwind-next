...
export function UsedSpaceWidget({ percentage }: UsedSpaceWidgetProps) {
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5">
      <div className="space-y-1">
        ...
        <p className="text-sm/5 text-violet-500">
          Your team has used {percentage}% of your available space. Need more?
        </p>
      </div>
      ...
      <div className="h-2 rounded-full bg-violet-200">
        <div
          ...
          style={{ width: `${percentage}%` }} // Alteração aqui
        />
      </div>
